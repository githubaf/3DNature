...
// this is to incude a file in the Hash toolkit of OSX
// Useful.h is included in most places string.h is
#ifdef __MACH__
#include <winstring.h>
#endif
...
UsefulPathString
---------------------------------------
unsigned long int MAKE_ID(long a, long b, long c, long d);
...
inline void Swap16S(signed short int &A, signed short int &B) {register signed short int C; C=A;A=B;B=C;};
inline void Swap16U(unsigned short int &A, unsigned short int &B) {register unsigned short int C; C=A;A=B;B=C;};
