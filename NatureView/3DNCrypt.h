...
int CalcHashOfFileFromName(const char *InFileName, unsigned char *SigOutSixteen, unsigned long int MaxInputLength, unsigned char AllowECWHash);
...
unsigned long int CalcHashOfECW(const char *InName, unsigned char *SigOutSixteen);
