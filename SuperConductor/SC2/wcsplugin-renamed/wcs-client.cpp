...
wcsClient::wcsClient() {
	...
	// add more client-specific settings... ?
...
void wcsClient::render(QString projName, long int frame) {
    // this is probably the best place to connect... load info from settings
