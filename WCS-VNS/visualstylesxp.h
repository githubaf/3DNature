...
#define USE_VSSYM32
#endif
#if defined(NTDDI_VERSION) && defined(NTDDI_VISTA)
...
#define WINGDI_H_RGB(r,g,b)          ((COLORREF)(((BYTE)(r)|((WORD)((BYTE)(g))<<8))|(((DWORD)(BYTE)(b))<<16)))
#ifndef _T
	#define _T(a) a
#endif
...
private:
	...
	typedef HRESULT(__stdcall *PFNGETTHEMEBITMAP)(HTHEME hTheme, HDC hdc, 
		int iPartId, int iStateId, int iPropId, ULONG dwFlags, HBITMAP *phBitmap);
	static HRESULT GetThemeBitmapFail(HTHEME, HDC, int, int, int, ULONG, HBITMAP *)
	{return E_FAIL;}
	...
	{return WINGDI_H_RGB(255,255,255);}
	...
	{return E_FAIL;}
public:
	HMODULE GetDll(void) {return(m_hThemeDll);};
	HMODULE GetRcDll(void) {return(m_hRcDll);};
	HMODULE LoadThemeRcDll(void);
	HBITMAP LoadBitmapFromTheme(LPCWSTR pszBitmapName);
	HTHEME OpenThemeData(HWND hwnd, LPCWSTR pszClassList);
	HRESULT CloseThemeData(HTHEME hTheme);
	HRESULT GetThemeBitmap(HTHEME hTheme, HDC hdc, 
		int iPartId, int iStateId, int iPropId, ULONG dwFlags, HBITMAP *phBitmap);
