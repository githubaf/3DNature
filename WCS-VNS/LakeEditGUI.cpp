...
char *LakeEditGUI::TabNames[WCS_LAKEGUI_NUMTABS] = {"General", "Water", "Beach Height", "Beach", "Foliage"};
char *LakeEditGUI::WaterTabNames[4] = {"Water", "Elevation", "Foam", "Waves"};

long LakeEditGUI::ActivePage;
long LakeEditGUI::ActivePanel;
// advanced
long LakeEditGUI::DisplayAdvanced;
...
#define WCS_LAKEED_WATERMAT_PAGE	1
// foliage page defines
#define WCS_LAKEED_FOLIAGE_PAGE	4
#define WCS_LAKEED_FOLIAGE_PANELSET	2
#define WCS_LAKEED_FOLIAGE_ECOTYPESET	3
// material GUI
#define WCS_LAKEED_BEACH_MATGRADSET	4
#define WCS_LAKEED_WATER_MATGRADSET	6

NativeGUIWin LakeEditGUI::Open(Project *Moi)
{
...
NativeGUIWin LakeEditGUI::Construct(void)
{
int TabIndex;
...
if (!NativeWin)
	...
	CreateSubWinFromTemplate(IDD_LAKE_GENERAL_VNS, 0, 0);
	CreateSubWinFromTemplate(IDD_LAKE_WATERMAT, 0, WCS_LAKEED_WATERMAT_PAGE);
	CreateSubWinFromTemplate(IDD_LAKE_BEACHGRAD, 0, 2);
	CreateSubWinFromTemplate(IDD_LAKE_BEACHMAT_VNS3, 0, 3);
	// foliage page resources
	CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_VNS3, 0, WCS_LAKEED_FOLIAGE_PAGE);
	CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPE1_FORESTRY, WCS_LAKEED_FOLIAGE_PANELSET, 0);
	// forestry
	#ifdef WCS_FORESTRY_WIZARD
	...
	if (GlobalApp->ForestryAuthorized || (GlobalApp->ForestryAuthorized = ((GlobalApp->Sentinal->CheckAuthFieldForestry() 
		...
		{
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPE2_FORESTRY, WCS_LAKEED_FOLIAGE_PANELSET, 1);
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPE3_FORESTRY, WCS_LAKEED_FOLIAGE_PANELSET, 2);
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_FOLIAGEGROUP_FORESTRY, WCS_LAKEED_FOLIAGE_PANELSET, 3);
		#ifdef WCS_BUILD_DEMO
	...
	#endif // WCS_FORESTRY_WIZARD
		{
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPE2, WCS_LAKEED_FOLIAGE_PANELSET, 1);
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPE3, WCS_LAKEED_FOLIAGE_PANELSET, 2);
		CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_FOLIAGEGROUP, WCS_LAKEED_FOLIAGE_PANELSET, 3);
		} // else
	CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_FOLIAGE, WCS_LAKEED_FOLIAGE_PANELSET, 4);
	CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_3DOBJECT, WCS_LAKEED_FOLIAGE_PANELSET, 5);
	CreateSubWinFromTemplate(IDD_ECOSYSTEM_FOLIAGE_ECOTYPETAB, WCS_LAKEED_FOLIAGE_ECOTYPESET, 0);
	// end foliage resources

	CreateSubWinFromTemplate(IDD_LAKE_WATERPROP_TRANSP, 1, 0);
	CreateSubWinFromTemplate(IDD_LAKE_ELEVATION, 1, 1);
	CreateSubWinFromTemplate(IDD_LAKE_FOAM, 1, 2);
	CreateSubWinFromTemplate(IDD_LAKE_WAVES, 1, 3);

	if (NativeWin)
		{
		for (TabIndex = 0; TabIndex < WCS_LAKEGUI_NUMTABS; TabIndex ++)
			{
		...
		// Material GUI
		BeachMatGUI->Construct(WCS_LAKEED_BEACH_MATGRADSET, WCS_LAKEED_BEACH_MATGRADSET + 1);
		WaterMatGUI->Construct(WCS_LAKEED_WATER_MATGRADSET, WCS_LAKEED_WATER_MATGRADSET + 1);
		ShowPanels();
		ConfigureWidgets();
		} // if
	} // if
...
} // LakeEditGUI::Construct

/*===========================================================================*/

LakeEditGUI::LakeEditGUI(EffectsLib *EffectsSource, Project *ProjSource, Database *DBSource, ImageLib *ImageSource, LakeEffect *ActiveSource)
: GUIFenetre('LKEF', this, "Lake Editor"), CommonComponentEditor((GeneralEffect **)(&Active), (Fenetre *)this)
{
static NotifyTag AllEvents[] = {MAKE_ID(WCS_EFFECTSSUBCLASS_LAKE, 0xff, 0xff, 0xff), 
...
if (EffectsSource && ActiveSource)
	{
	sprintf(NameStr, "Lake Editor - %s", Active->GetName());
	...
	if (! (FolGUI = new PortableFoliageGUI(this, EffectsSource, ImageSource, &Active->BeachMat, NULL,
		WCS_LAKEED_FOLIAGE_PAGE, WCS_LAKEED_FOLIAGE_PANELSET, WCS_LAKEED_FOLIAGE_ECOTYPESET, ActivePage)))
		ConstructError = 1;
	// Material GUI
	if (BeachMatGUI = new PortableMaterialGUI(0, this, EffectsSource, Active, &Active->BeachMat, WCS_EFFECTS_LAKE_ANIMPAR_BEACHMATDRIVER, WCS_EFFECTS_LAKE_TEXTURE_BEACHMATDRIVER)) // init ordinal 0
		{
	...
	if (WaterMatGUI = new PortableMaterialGUI(1, this, EffectsSource, Active, &Active->WaterMat, WCS_EFFECTS_LAKE_ANIMPAR_WATERMATDRIVER, WCS_EFFECTS_LAKE_TEXTURE_WATERMATDRIVER)) // init ordinal 1
		{
...
long LakeEditGUI::HandleCloseWin(NativeGUIWin NW)
{

AppScope->MCP->SetParam(1, WCS_TOOLBARCLASS_MODULES, WCS_TOOLBAR_CLOSE_MOD,
	WCS_TOOLBAR_ITEM_LEG, 0);

return(0);

} // LakeEditGUI::HandleCloseWin

/*===========================================================================*/

// advanced
long LakeEditGUI::HandleShowAdvanced(NativeGUIWin NW, bool NewState)
{
...
} // LakeEditGUI::HandleShowAdvanced

/*===========================================================================*/

long LakeEditGUI::HandleButtonClick(NativeControl Handle, NativeGUIWin NW, int ButtonID)
{
...
} // LakeEditGUI::HandleButtonClick

/*===========================================================================*/

long LakeEditGUI::HandleButtonDoubleClick(NativeControl Handle, NativeGUIWin NW, int ButtonID)
{
...
} // LakeEditGUI::HandleButtonDoubleClick

/*===========================================================================*/

long LakeEditGUI::HandleListDelItem(NativeControl Handle, NativeGUIWin NW, int CtrlID, void *ItemData)
{
...
} // LakeEditGUI::HandleListDelItem

/*===========================================================================*/

long LakeEditGUI::HandleListDoubleClick(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
...
} // LakeEditGUI::HandleListDoubleClick

/*===========================================================================*/

long LakeEditGUI::HandleListCopyItem(NativeControl Handle, NativeGUIWin NW, int CtrlID, void *ItemData)
{
...
} // LakeEditGUI::HandleListCopyItem

/*===========================================================================*/

long LakeEditGUI::HandleListPasteItem(NativeControl Handle, NativeGUIWin NW, int CtrlID, void *ItemData)
{
...
} // LakeEditGUI::HandleListPasteItem

/*===========================================================================*/

long LakeEditGUI::HandleTreeMenuSelect(NativeControl Handle, NativeGUIWin NW, int CtrlID, unsigned long TreeItem, RasterAnimHost *RAH, char *ActionText, int Derived)
{
...
} // LakeEditGUI::HandleTreeMenuSelect

/*===========================================================================*/

long LakeEditGUI::HandleTreeChange(NativeControl Handle, NativeGUIWin NW, int CtrlID, unsigned long OldTreeItem, unsigned long NewTreeItem, void *TreeItemData)
{
...
} // LakeEditGUI::HandleTreeChange

/*===========================================================================*/

long LakeEditGUI::HandleTreeExpand(NativeControl Handle, NativeGUIWin NW, int CtrlID, unsigned long TreeItem, void *TreeItemData, char Pre, char Expand)
{
...
} // LakeEditGUI::HandleTreeExpand

/*===========================================================================*/

long LakeEditGUI::HandleCBChange(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
...
} // LakeEditGUI::HandleCBChange

/*===========================================================================*/

long LakeEditGUI::HandleStringLoseFocus(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
...
} // LakeEditGUI::HandleStringLoseFocus

/*===========================================================================*/

long LakeEditGUI::HandlePageChange(NativeControl Handle, NativeGUIWin NW, int CtrlID, long NewPageID)
{
...
} // LakeEditGUI::HandlePageChange

/*===========================================================================*/

void LakeEditGUI::ShowPanels(void)
{

ShowPanel(0, ActivePage);
ShowPanel(1, ActivePage == WCS_LAKEED_WATERMAT_PAGE ? ActivePanel: -1);
// foliage page
if (ActivePage == WCS_LAKEED_FOLIAGE_PAGE)
	FolGUI->ShowPanels();
else
	FolGUI->HidePanels();
	
} // LakeEditGUI::ShowPanels

/*===========================================================================*/

long LakeEditGUI::HandleSCChange(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
NotifyTag Changes[2];
...
switch (CtrlID)
	...
	//	{
	//	EffectsHost->LakeBase.SetFloating(EffectsHost->LakeBase.Floating, ProjHost);		// this sends the valuechanged message
	//	break;
	//	} // 
	default:
		break;
...
} // LakeEditGUI::HandleSCChange

/*===========================================================================*/

long LakeEditGUI::HandleSRChange(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
NotifyTag Changes[2];
...
} // LakeEditGUI::HandleSRChange

/*===========================================================================*/

long LakeEditGUI::HandleFIChange(NativeControl Handle, NativeGUIWin NW, int CtrlID)
{
...
} // LakeEditGUI::HandleFIChange

/*===========================================================================*/

void LakeEditGUI::HandleNotifyEvent(void)
{
...
} // LakeEditGUI::HandleNotifyEvent()

/*===========================================================================*/

void LakeEditGUI::ConfigureWidgets(void)
{
char TextStr[256];
...
/*
if (EffectsHost->LakeBase.AreThereEdges((GeneralEffect *)EffectsHost->Lake))
...
/*ConfigureFI(NativeWin, IDC_RESOLUTION,
 &EffectsHost->LakeBase.Resolution,
  1.0,
   0.00001,
	1000000.0,
	 FIOFlag_Float,
...
sprintf(TextStr, "Lake Editor - %s", Active->GetName());
if (Active->GetRAHostRoot()->TemplateItem)
...
//ConfigureSC(NativeWin, IDC_CHECKOVERLAP, &EffectsHost->LakeBase.OverlapOK, SCFlag_Short, NULL, 0);
//ConfigureSC(NativeWin, IDC_CHECKFLOATING, &EffectsHost->LakeBase.Floating, SCFlag_Short, NULL, 0);
//ConfigureSC(NativeWin, IDC_CHECKHIRESEDGE, &Active->HiResEdge, SCFlag_Short, NULL, 0);
ConfigureSC(NativeWin, IDC_CHECKBEACHREF, &Active->WaterlineRefType, SCFlag_Char, NULL, 0);
...
WidgetSmartRAHConfig(IDC_BEACHHTMIN, &Active->AnimPar[WCS_EFFECTS_LAKE_ANIMPAR_BEACHHT], Active);
WidgetSmartRAHConfig(IDC_BEACHHTMAX, &Active->AnimPar[WCS_EFFECTS_LAKE_ANIMPAR_BEACHHTVAR], Active);
WidgetSmartRAHConfig(IDC_ELEV, &Active->AnimPar[WCS_EFFECTS_LAKE_ANIMPAR_ELEV], Active);
WidgetSmartRAHConfig(IDC_BEACHREFELEV, &Active->AnimPar[WCS_EFFECTS_LAKE_ANIMPAR_WATERLINEREF], Active);
...
} // LakeEditGUI::ConfigureWidgets()

/*===========================================================================*/

void LakeEditGUI::ConfigureBeach(void)
{
MaterialEffect *Mat;
...
} // LakeEditGUI::ConfigureBeach

/*===========================================================================*/

void LakeEditGUI::ConfigureWater(void)
{
MaterialEffect *Mat;
...
} // LakeEditGUI::ConfigureWater

/*===========================================================================*/

void LakeEditGUI::BuildWaveList(void)
{
EffectList *Current;
...
} // LakeEditGUI::BuildWaveList

/*===========================================================================*/

void LakeEditGUI::BuildWaveListEntry(char *ListName, GeneralEffect *Me)
{
...
} // LakeEditGUI::BuildWaveListEntry()

/*===========================================================================*/

void LakeEditGUI::ConfigureColors(void)
{
...
} // LakeEditGUI::ConfigureColors

/*===========================================================================*/

void LakeEditGUI::SyncWidgets(void)
{
...
WidgetSCSync(IDC_CHECKBEACHREF, WP_SCSYNC_NONOTIFY);
...
WidgetSNSync(IDC_BEACHREFELEV, WP_FISYNC_NONOTIFY);
...
} // LakeEditGUI::SyncWidgets

/*===========================================================================*/

void LakeEditGUI::DisableWidgets(void)
{
MaterialEffect *Mat;
...
// beach material
WidgetSetDisabled(IDC_BEACHREFELEV, Active->WaterlineRefType != WCS_LAKE_REFTYPE_ANIMVALUE);
...
} // LakeEditGUI::DisableWidgets

/*===========================================================================*/

// advanced
void LakeEditGUI::DisplayAdvancedFeatures(void)
{
...
} // LakeEditGUI::DisplayAdvancedFeatures

/*===========================================================================*/

void LakeEditGUI::Cancel(void)
{
NotifyTag Changes[2];
...
void LakeEditGUI::RemoveWave(void)
{
...
} // LakeEditGUI::RemoveWave

/*===========================================================================*/

void LakeEditGUI::EditWave(void)
{
...
} // LakeEditGUI::EditWave

/*===========================================================================*/

void LakeEditGUI::Name(void)
{
NotifyTag Changes[2];
...
void LakeEditGUI::SetToFoliagePage(void)
{

ActivePage = WCS_LAKEED_FOLIAGE_PAGE;
FolGUI->SetActivePage(ActivePage);
WidgetTCSetCurSel(IDC_TAB1, ActivePage);
ShowPanels();

} // LakeEditGUI::SetToFoliagePage

/*===========================================================================*/

void LakeEditGUI::ActivateFoliageItem(RasterAnimHost *ActivateMe)
{

FolGUI->EditFoliageItem(ActivateMe, 0);

} // LakeEditGUI::ActivateFoliageItem

/*===========================================================================*/

// Material GUI
void LakeEditGUIBeachPortableMaterialGUINotifyFunctor::HandleConfigureMaterial(void)
{

if (Host) Host->ConfigureBeach();

} // LakeEditGUIBeachPortableMaterialGUINotifyFunctor::HandleConfigureMaterial

/*===========================================================================*/

// Material GUI
void LakeEditGUIBeachPortableMaterialGUINotifyFunctor::HandleNewActiveGrad(GradientCritter *NewNode)
{

if (Host) Host->SetNewActiveBeachGrad(NewNode);

} // LakeEditGUIBeachPortableMaterialGUINotifyFunctor::HandleNewActiveGrad

/*===========================================================================*/

// Material GUI
void LakeEditGUIWaterPortableMaterialGUINotifyFunctor::HandleConfigureMaterial(void)
{

if (Host) Host->ConfigureWater();

} // LakeEditGUIWaterPortableMaterialGUINotifyFunctor::HandleConfigureMaterial

/*===========================================================================*/

// Material GUI
void LakeEditGUIWaterPortableMaterialGUINotifyFunctor::HandleNewActiveGrad(GradientCritter *NewNode)
{

if (Host) Host->SetNewActiveWaterGrad(NewNode);

} // LakeEditGUIWaterPortableMaterialGUINotifyFunctor::HandleNewActiveGrad

/*===========================================================================*/

// material GUI
void LakeEditGUI::ShowBeachMaterialPopDrop(bool ShowState)
{
...
} // LakeEditGUI::ShowBeachMaterialPopDrop

/*===========================================================================*/

void LakeEditGUI::ShowWaterMaterialPopDrop(bool ShowState)
{
...
} // LakeEditGUI::ShowWaterMaterialPopDrop

/*===========================================================================*/

bool LakeEditGUI::QueryLocalDisplayAdvancedUIVisibleState(void)
{

return(DisplayAdvanced || Active->BeachMat.CountNodes() > 1 || Active->WaterMat.CountNodes() > 1 ? true : false);

} // LakeEditGUI::QueryLocalDisplayAdvancedUIVisibleState
