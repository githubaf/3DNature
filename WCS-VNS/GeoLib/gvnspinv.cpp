...
InverseOK[WCS_PROJECTIONCODE_GVNSP] = 1;
InverseTransform = &Projectoid::gvnspinv;
...
// General Vertical Near-Side Perspective inverse equations--mapping x,y to lat/long
long Projectoid::gvnspinv(
