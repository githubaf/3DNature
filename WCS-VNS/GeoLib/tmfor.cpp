...
ForwardOK[WCS_PROJECTIONCODE_TM] = 1;
ForwardTransform = &Projectoid::tmfor;
...
*x  = scale_factor * n * al * (1.0 + als * (1.0 / 6.0) * (1.0 - t + c + als * (1.0 / 20.0) *
      (5.0 - 18.0 * t + SQUARE(t) + 72.0 * c - 58.0 * esp))) + false_easting;

*y  = scale_factor * (ml - ml0 + n * tq * (als * (0.5 + als * (1.0 / 24.0) *
