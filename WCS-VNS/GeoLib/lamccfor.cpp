...
if (fabs(lat1 + lat2) < EPSLN)
	{
	p_error("Equal latitudes for St. Parallels on opposite sides of equator", "lamcc-for");
	return(41);
	}
...
ForwardOK[WCS_PROJECTIONCODE_LAMCC] = 1;
ForwardTransform = &Projectoid::lamccfor;
