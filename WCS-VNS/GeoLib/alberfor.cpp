...
if (fabs(lat1 + lat2) < EPSLN)
	{
	p_error("Equal latitudes for Std. Parallels on opposite sides of equator", "alber-forinit");
	return(31);
	}
r_major = r_maj;
r_minor = r_min;
...
ForwardOK[WCS_PROJECTIONCODE_ALBERS] = 1;
ForwardTransform = &Projectoid::alberfor;
