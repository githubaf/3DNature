...
ForwardOK[WCS_PROJECTIONCODE_AZMEQD] = 1;
ForwardTransform = &Projectoid::azimfor;
...
*y = false_northing + r_major * ksp * (cos_p12 * sinphi - sin_p12 * cosphi * coslon);
