...
if (fabs(lat1 + lat2) < EPSLN)
	{
	p_error("Equal latitudes for Standard Parallels on opposite sides of equator", "alber-invinit");
	return(31);
	}
r_major = r_maj;
r_minor = r_min;
...
InverseOK[WCS_PROJECTIONCODE_ALBERS] = 1;
InverseTransform = &Projectoid::alberinv;
