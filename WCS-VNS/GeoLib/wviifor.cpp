...
ForwardOK[WCS_PROJECTIONCODE_WAGVII] = 1;
ForwardTransform = &Projectoid::wviifor;
...
sincos((delta_lon * ( 1.0 / 3.0)), &sin_lon, &cos_lon);	// <<<F2 OPT>>>
s = 0.90631 * sin(lat);
c0 = sqrt(1 - s * s);
