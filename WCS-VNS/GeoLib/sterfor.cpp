...
ForwardOK[WCS_PROJECTIONCODE_STEREO] = 1;
ForwardTransform = &Projectoid::sterfor;
...
if (fabs(g + 1.0) <= EPSLN)
	...
	*y = false_northing + r_major * ksp * (cos_p10 * sinphi - sin_p10 * cosphi * coslon);
	}
return(OK);
