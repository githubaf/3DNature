...
ForwardOK[WCS_PROJECTIONCODE_GNOMON] = 1;
ForwardTransform = &Projectoid::gnomfor;
...
*y = false_northing + R * ksp * (cos_p13 * sinphi - sin_p13 * cosphi * coslon);
