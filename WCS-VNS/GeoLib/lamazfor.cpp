...
ForwardOK[WCS_PROJECTIONCODE_LAMAZ] = 1;
ForwardTransform = &Projectoid::lamazfor;
...
*y = ksp * (cos_lat_o * sin_lat - sin_lat_o * cos_lat * cos_delta_lon) + false_northing;
