...
chi = 2.0 * atan(tan((HALF_PI + lat_center) * (1.0 / 2.0)) * pow(((1.0 - esphi) / (1.0 + esphi)), (e * (1.0 / 2.0)))) - HALF_PI;	// <<<F2 OPT>>>
...
ForwardOK[WCS_PROJECTIONCODE_ALASKA] = 1;
ForwardTransform = &Projectoid::alconfor;
...
esphi = e * sin(lat);
chi = 2.0 * atan(tan((HALF_PI + lat) * (1.0 / 2.0)) * pow(((1.0 - esphi) / (1.0 + esphi)), (e * (1.0 / 2.0)))) - HALF_PI;	// <<<F2 OPT>>>
