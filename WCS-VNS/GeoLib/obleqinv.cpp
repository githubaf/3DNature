...
InverseOK[WCS_PROJECTIONCODE_OBEQA] = 1;
InverseTransform = &Projectoid::obleqinv;
...
temp = sqrt(x_prime * x_prime + y_prime * y_prime) * (1.0 / 2.0);	// <<<F2 OPT>>>
z = 2.0 * asin(temp);
...
*lon = adjust_lon(lon_center + atan2((sin_z * sin_diff_angle), (cos_lat_o * cos_z - sin_lat_o * sin_z * cos_diff_angle)));
