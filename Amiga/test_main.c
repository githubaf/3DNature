...
#define oritzroiuzoritzoiu
   ...
   { "WCSDEM -> Array Int 1",  "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IS1",        "test_files/reference/ref_36112IS1",__LINE__       }, //  -> display -depth   8 -size 301x301 gray:ref_36112IS1  -> nur grau
   { "WCSDEM -> Array Int 2",  "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IS2",        "test_files/reference/ref_36112IS2",__LINE__       }, //  -> display -depth  16 -size 301x301 -define endian=MSB -normalize gray:ref_36112IS2
   { "WCSDEM -> Array Int 4",  "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IS4",        "test_files/reference/ref_36112IS4",__LINE__       }, //  -> display -depth  32 -size 301x301 gray:ref_36112IS4
   { "WCSDEM -> Array UInt 1", "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IU1",        "test_files/reference/ref_36112IU1",__LINE__       }, //  -> display -depth   8 -size 301x301 gray:ref_36112IU1 -> nur weiss
   { "WCSDEM -> Array UInt 2", "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IU2",        "test_files/reference/ref_36112IU2",__LINE__       }, //  -> display -depth  16 -size 301x301 -define endian=MSB -normalize gray:ref_36112IU2
   { "WCSDEM -> Array UInt 4", "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IU4",        "test_files/reference/ref_36112IU4",__LINE__       }, //  -> display -depth  32 -size 301x301 gray:ref_36112IU4
   { "WCSDEM -> Array Float 4","test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IF4",        "test_files/reference/ref_36112IF4",__LINE__       }, //  -> display -endian MSB -depth 32 -size 301x301 -define quantum:format=floating-point -define quantum:scale=3e+01 gray:ref_36112IF4
   { "WCSDEM -> Array Float 8","test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IF8",        "test_files/reference/ref_36112IF8",__LINE__       }, //  -> display -endian MSB -depth 64 -size 301x301 -define quantum:format=floating-point -define quantum:scale=3e+01 gray:ref_36112IF8
   { "WCSDEM -> WCSDEM",       "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112I",          "test_files/reference/ref_36112I",__LINE__         },
   { "WCSDEM -> ZBUF",         "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112I",          "test_files/reference/ref_36112IZB",__LINE__       }, //  -> tail --bytes $((301*301*4)) ref_36112IZB | display -endian MSB -depth 32 -size 301x301 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=3e+01 gray: #creates ref_36112IZB
   { "WCSDEM -> COLORMAP",     "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112I",          "test_files/reference/ref_36112I",__LINE__         }, // display -depth 8 -size 301x301 gray:ref_36112I.red (.grn, .blu), creates ref_36112I.red, grn and blu
   { "WCSDEM -> GRAYIFF",      "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IGray.iff",  "test_files/reference/ref_36112IGray.iff",__LINE__ }, // display ref_36112IGray.iff, identify ref_36112IGray.iff -> nur weiss
   { "WCSDEM -> COLORIFF",     "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301, NULL,NULL, 651, 2316, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  301,301,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112IColor.iff", "test_files/reference/ref_36112IColor.iff",__LINE__}, // display ref_36112IColor.iff, identify ref_36112IColor.iff -> nur weiss
   ...
   { "ZBUF -> Array Int 1",  "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBS1",        "test_files/reference/ref_BSurZBS1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurZBS1
   { "ZBUF -> Array Int 2",  "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBS2",        "test_files/reference/ref_BSurZBS2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurZBS2
   { "ZBUF -> Array Int 4",  "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBS4",        "test_files/reference/ref_BSurZBS4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurZBS4
   { "ZBUF -> Array UInt 1", "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBU1",        "test_files/reference/ref_BSurZBU1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurZBU1
   { "ZBUF -> Array UInt 2", "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBU2",        "test_files/reference/ref_BSurZBU2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurZBU2
   { "ZBUF -> Array UInt 4", "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBU4",        "test_files/reference/ref_BSurZBU4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurZBU4
   { "ZBUF -> Array Float 4","test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBF4",        "test_files/reference/ref_BSurZBF4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=8e+01 gray:ref_BSurZBF4
   { "ZBUF -> Array Float 8","test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBF8",        "test_files/reference/ref_BSurZBF8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=8e+01 gray:ref_BSurZBF8
   { "ZBUF -> WCSDEM",       "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_KILOM,  DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZB",          "test_files/reference/ref_BSurZB",__LINE__         },
   { "ZBUF -> ZBUF",         "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZB",          "test_files/reference/ref_BSurZBZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurZBZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates ref_BSurZBZB
   { "ZBUF -> COLORMAP",     "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZB",          "test_files/reference/ref_BSurZB",__LINE__         },  // OK ->display -depth 8 -size 258x258 gray:ref_BSurZB.red (.grn, .blu), creates ref_BSurZB.red, grn and blu
   { "ZBUF -> GRAYIFF",      "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBGray.iff",  "test_files/reference/ref_BSurZBGray.iff",__LINE__ },  // OK -> display ref_BSurZBGray.iff, identify ref_BSurZBGray.iff
   { "ZBUF -> COLORIFF",     "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZBColor.iff", "test_files/reference/ref_BSurZBColor.iff",__LINE__},  // OK -> display ref_BSurZBColor.iff, identify ref_BSurZBColor.iff

   // BIN Array S1
   { "Array Int 1 -> Array Int 1",  "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1S1",        "test_files/reference/ref_BSurS1S1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurS1S1
   { "Array Int 1 -> Array Int 2",  "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1S2",        "test_files/reference/ref_BSurS1S2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS1S2
   { "Array Int 1 -> Array Int 4",  "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1S4",        "test_files/reference/ref_BSurS1S4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurS1S4
   { "Array Int 1 -> Array UInt 1", "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1U1",        "test_files/reference/ref_BSurS1U1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurS1U1
   { "Array Int 1 -> Array UInt 2", "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1U2",        "test_files/reference/ref_BSurS1U2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS1U2
   { "Array Int 1 -> Array UInt 4", "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1U4",        "test_files/reference/ref_BSurS1U4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurS1U4
   { "Array Int 1 -> Array Float 4","test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1F4",        "test_files/reference/ref_BSurS1F4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=3e+02 gray:ref_BSurS1F4
   { "Array Int 1 -> Array Float 8","test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1F8",        "test_files/reference/ref_BSurS1F8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=3e+02 gray:ref_BSurS1F8
   { "Array Int 1 -> WCSDEM",       "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1",          "test_files/reference/ref_BSurS1",__LINE__         },
   { "Array Int 1 -> ZBUF",         "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1",          "test_files/reference/ref_BSurS1ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurS1ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates ref_BSurS1ZB
   { "Array Int 1 -> COLORMAP",     "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1",          "test_files/reference/ref_BSurS1",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurS1.red (.grn, .blu), creates ref_BSurS1.red, grn and blu
   { "Array Int 1 -> GRAYIFF",      "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1Gray.iff",  "test_files/reference/ref_BSurS1Gray.iff",__LINE__ },  // OK -> display ref_BSurS1Gray.iff, identify ref_BSurS1Gray.iff
   { "Array Int 1 -> COLORIFF",     "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS1Color.iff", "test_files/reference/ref_BSurS1Color.iff",__LINE__},  // OK -> display ref_BSurS1Color.iff, identify ref_BSurS1Color.iff

   // BIN Array S2
   { "Array Int 2 -> Array Int 1",  "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2S1",        "test_files/reference/ref_BSurS2S1",__LINE__       },  //  OK -> display -depth   8 -size 258x258 gray:ref_BSurS2S1
   { "Array Int 2 -> Array Int 2",  "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2S2",        "test_files/reference/ref_BSurS2S2",__LINE__       },  //  OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS2S2
   { "Array Int 2 -> Array Int 4",  "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2S4",        "test_files/reference/ref_BSurS2S4",__LINE__       },  //  OK -> display -depth  32 -size 258x258 gray:ref_BSurS2S4
   { "Array Int 2 -> Array UInt 1", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U1",        "test_files/reference/ref_BSurS2U1",__LINE__       },  //  OK -> display -depth   8 -size 258x258 gray:ref_BSurS2U1
   { "Array Int 2 -> Array UInt 2", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U2",        "test_files/reference/ref_BSurS2U2",__LINE__       },  //  OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS2U2
   { "Array Int 2 -> Array UInt 4", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U4",        "test_files/reference/ref_BSurS2U4",__LINE__       },  //  OK -> display -depth  32 -size 258x258 gray:ref_BSurS2U4
   { "Array Int 2 -> Array Float 4","test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2F4",        "test_files/reference/ref_BSurS2F4",__LINE__       },  //  OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurS2F4
   { "Array Int 2 -> Array Float 8","test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2F8",        "test_files/reference/ref_BSurS2F8",__LINE__       },  //  OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurS2F8
   { "Array Int 2 -> WCSDEM",       "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2",          "test_files/reference/ref_BSurS2",__LINE__         },  //
   { "Array Int 2 -> ZBUF",         "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2",          "test_files/reference/ref_BSurS2ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurS2ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates ref_BSurS2ZB
   { "Array Int 2 -> COLORMAP",     "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2",          "test_files/reference/ref_BSurS2",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurS1.red (.grn, .blu), creates ref_BSurS1.red, grn and blu                                                                                                           K -> display -depth 8 -size 258x258 gray:ref_BSurS2.red (.grn, .blu), creates tst_BSurS2.red, grn and blu
   { "Array Int 2 -> GRAYIFF",      "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2Gray.iff",  "test_files/reference/ref_BSurS2Gray.iff",__LINE__ },  // OK -> display ref_BSurS1Gray.iff, identify ref_BSurS1Gray.iff                                                                                                                                                        K -> display ref_BSurS2Gray.iff, identify ref_BSurS2Gray.iff
   { "Array Int 2 -> COLORIFF",     "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2Color.iff", "test_files/reference/ref_BSurS2Color.iff",__LINE__},  // OK -> display ref_BSurS1Color.iff, identify ref_BSurS1Color.iff                                                                                                                                                      K -> display ref_BSurS2Color.iff, identify ref_BSurS2Color.iff

   // BIN Array S4
   { "Array Int 4 -> Array Int 1",  "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4S1",        "test_files/reference/ref_BSurS4S1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurS4S1
   { "Array Int 4 -> Array Int 2",  "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4S2",        "test_files/reference/ref_BSurS4S2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS4S2
   { "Array Int 4 -> Array Int 4",  "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4S4",        "test_files/reference/ref_BSurS4S4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurS4S4
   { "Array Int 4 -> Array UInt 1", "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4U1",        "test_files/reference/ref_BSurS4U1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurS4U1
   { "Array Int 4 -> Array UInt 2", "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4U2",        "test_files/reference/ref_BSurS4U2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurS4S2
   { "Array Int 4 -> Array UInt 4", "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4U4",        "test_files/reference/ref_BSurS4U4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurS4U4
   { "Array Int 4 -> Array Float 4","test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4F4",        "test_files/reference/ref_BSurS4F4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurS4F4
   { "Array Int 4 -> Array Float 8","test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4F8",        "test_files/reference/ref_BSurS4F8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurS4F8
   { "Array Int 4 -> WCSDEM",       "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4",          "test_files/reference/ref_BSurS4",__LINE__         },
   { "Array Int 4 -> ZBUF",         "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4",          "test_files/reference/ref_BSurS4ZB",__LINE__       },
   { "Array Int 4 -> COLORMAP",     "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4",          "test_files/reference/ref_BSurS4",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurS4.red (.grn, .blu), creates tst_BSurS4.red, grn and blu
   { "Array Int 4 -> GRAYIFF",      "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4Gray.iff",  "test_files/reference/ref_BSurS4Gray.iff",__LINE__ },  // OK -> display ref_BSurS4Gray.iff, identify ref_BSurS4Gray.iff
   { "Array Int 4 -> COLORIFF",     "test_files/source/BSur.DEMS4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS4Color.iff", "test_files/reference/ref_BSurS4Color.iff",__LINE__},  // OK -> display ref_BSurS4Color.iff, identify ref_BSurS4Color.iff

//   { "Array Int 2 -> Array Int 2",  "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2S2",        "test_files/reference/ref_BSurS2S2",__LINE__       },
//   { "Array Int 2 -> Array Int 4",  "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2S4",        "test_files/reference/ref_BSurS2S4",__LINE__       },
//   { "Array Int 2 -> Array UInt 1", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U1",        "test_files/reference/ref_BSurS2U1",__LINE__       },
//   { "Array Int 2 -> Array UInt 2", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U2",        "test_files/reference/ref_BSurS2U2",__LINE__       },
//   { "Array Int 2 -> Array UInt 4", "test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2U4",        "test_files/reference/ref_BSurS2U4",__LINE__       },
...
//   { "Array Int 2 -> Array Float 8","test_files/source/BSur.DEMS2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0, 258, 258,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurS2F8",        "test_files/reference/ref_BSurS2F8",__LINE__       },

   // BIN Array U1
   { "Array UInt 1 -> Array Int 1",  "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,"127",  0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1S1",        "test_files/reference/ref_BSurU1S1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU1S1
   { "Array UInt 1 -> Array Int 2",  "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1S2",        "test_files/reference/ref_BSurU1S2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU1S2
   { "Array UInt 1 -> Array Int 4",  "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1S4",        "test_files/reference/ref_BSurU1S4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU1S4
   { "Array UInt 1 -> Array UInt 1", "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1U1",        "test_files/reference/ref_BSurU1U1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU1U1
   { "Array UInt 1 -> Array UInt 2", "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1U2",        "test_files/reference/ref_BSurU1U2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU1U2
   { "Array UInt 1 -> Array UInt 4", "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1U4",        "test_files/reference/ref_BSurU1U4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU1U4
   { "Array UInt 1 -> Array Float 4","test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1F4",        "test_files/reference/ref_BSurU1F4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=3e+02 gray:ref_BSurU1F4
   { "Array UInt 1 -> Array Float 8","test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1F8",        "test_files/reference/ref_BSurU1F8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=3e+02 gray:ref_BSurU1F8
   { "Array UInt 1 -> WCSDEM",       "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1",          "test_files/reference/ref_BSurU1",__LINE__         },
   { "Array UInt 1 -> ZBUF",         "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1",          "test_files/reference/ref_BSurU1ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurU1ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates tst_BSurU1ZB
   { "Array UInt 1 -> COLORMAP",     "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1",          "test_files/reference/ref_BSurU1",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurU1.red (.grn, .blu), creates tst_BSurU1.red, grn and blu
   { "Array UInt 1 -> GRAYIFF",      "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1Gray.iff",  "test_files/reference/ref_BSurU1Gray.iff",__LINE__ },  // OK -> display ref_BSurU1Gray.iff, identify ref_BSurU1Gray.iff
   { "Array UInt 1 -> COLORIFF",     "test_files/source/BSur.DEMU1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU1Color.iff", "test_files/reference/ref_BSurU1Color.iff",__LINE__},  // OK -> display ref_BSurU1Color.iff, identify ref_BSurU1Color.iff

   // BIN Array U2
   { "Array UInt 2 -> Array Int 1",  "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2S1",        "test_files/reference/ref_BSurU2S1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU2S1
   { "Array UInt 2 -> Array Int 2",  "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2S2",        "test_files/reference/ref_BSurU2S2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU2S2
   { "Array UInt 2 -> Array Int 4",  "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2S4",        "test_files/reference/ref_BSurU2S4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU2S4
   { "Array UInt 2 -> Array UInt 1", "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2U1",        "test_files/reference/ref_BSurU2U1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU2U1
   { "Array UInt 2 -> Array UInt 2", "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2U2",        "test_files/reference/ref_BSurU2U2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU2U2
   { "Array UInt 2 -> Array UInt 4", "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2U4",        "test_files/reference/ref_BSurU2U4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU2U4
   { "Array UInt 2 -> Array Float 4","test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2F4",        "test_files/reference/ref_BSurU2F4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurU2F4
   { "Array UInt 2 -> Array Float 8","test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2F8",        "test_files/reference/ref_BSurU2F8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurU2F8
   { "Array UInt 2 -> WCSDEM",       "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2",          "test_files/reference/ref_BSurU2",__LINE__         },
   ...
   { "Array UInt 2 -> GRAYIFF",      "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2Gray.iff",  "test_files/reference/ref_BSurU2Gray.iff",__LINE__ },  // OK -> display ref_BSurU2Gray.iff, identify ref_BSurU2Gray.iff
   { "Array UInt 2 -> COLORIFF",     "test_files/source/BSur.DEMU2",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU2Color.iff", "test_files/reference/ref_BSurU2Color.iff",__LINE__},  // OK -> display ref_BSurU2Color.iff, identify ref_BSurU2Color.iff

   // BIN Array U4
   { "Array UInt 4 -> Array Int 1",  "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4S1",        "test_files/reference/ref_BSurU4S1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU4S1
   { "Array UInt 4 -> Array Int 2",  "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4S2",        "test_files/reference/ref_BSurU4S2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU4S2
   { "Array UInt 4 -> Array Int 4",  "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4S4",        "test_files/reference/ref_BSurU4S4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU4S4
   { "Array UInt 4 -> Array UInt 1", "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4U1",        "test_files/reference/ref_BSurU4U1",__LINE__       },  // OK -> display -depth   8 -size 258x258 gray:ref_BSurU4U1
   { "Array UInt 4 -> Array UInt 2", "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4U2",        "test_files/reference/ref_BSurU4U2",__LINE__       },  // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurU4U2
   { "Array UInt 4 -> Array UInt 4", "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4U4",        "test_files/reference/ref_BSurU4U4",__LINE__       },  // OK -> display -depth  32 -size 258x258 gray:ref_BSurU4U4
   { "Array UInt 4 -> Array Float 4","test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4F4",        "test_files/reference/ref_BSurU4F4",__LINE__       },  // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurU4F4
   { "Array UInt 4 -> Array Float 8","test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4F8",        "test_files/reference/ref_BSurU4F8",__LINE__       },  // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurU4F8
   { "Array UInt 4 -> WCSDEM",       "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4",          "test_files/reference/ref_BSurU4",__LINE__         },
   { "Array UInt 4 -> ZBUF",         "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4",          "test_files/reference/ref_BSurU4ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurU4ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates tst_BSurU4ZB
   { "Array UInt 4 -> COLORMAP",     "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4",          "test_files/reference/ref_BSurU4",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurU4.red (.grn, .blu), creates tst_BSurU4.red, grn and blu
   { "Array UInt 4 -> GRAYIFF",      "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4Gray.iff",  "test_files/reference/ref_BSurU4Gray.iff",__LINE__ },  // OK -> display ref_BSurU4Gray.iff, identify ref_BSurU4Gray.iff
   { "Array UInt 4 -> COLORIFF",     "test_files/source/BSur.DEMU4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurU4Color.iff", "test_files/reference/ref_BSurU4Color.iff",__LINE__},  // OK -> display ref_BSurU4Color.iff, identify ref_BSurU4Color.iff

   // BIN Array F4
   { "Array Float 4 -> Array Int 1",  "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4S1",        "test_files/reference/ref_BSurF4S1",__LINE__       }, // OK display -depth   8 -size 258x258                               gray:ref_BSurF4S1
   { "Array Float 4 -> Array Int 2",  "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4S2",        "test_files/reference/ref_BSurF4S2",__LINE__       }, // OK display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurF4S2
   { "Array Float 4 -> Array Int 4",  "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4S4",        "test_files/reference/ref_BSurF4S4",__LINE__       }, // OK display -depth  32 -size 258x258                               gray:ref_BSurF4S4
   { "Array Float 4 -> Array UInt 1", "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4U1",        "test_files/reference/ref_BSurF4U1",__LINE__       }, // OK display -depth   8 -size 258x258                               gray:ref_BSurF4U1
   { "Array Float 4 -> Array UInt 2", "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4U2",        "test_files/reference/ref_BSurF4U2",__LINE__       }, // OK display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurF4U2
   { "Array Float 4 -> Array UInt 4", "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4U4",        "test_files/reference/ref_BSurF4U4",__LINE__       }, // OK display -depth  32 -size 258x258                               gray:ref_BSurF4U4
   { "Array Float 4 -> Array Float 4","test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4F4",        "test_files/reference/ref_BSurF4F4",__LINE__       }, // OK display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurF4F4
   { "Array Float 4 -> Array Float 8","test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4F8",        "test_files/reference/ref_BSurF4F8",__LINE__       }, // OK display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurF4F8
   { "Array Float 4 -> WCSDEM",       "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4",          "test_files/reference/ref_BSurF4",__LINE__         },
   { "Array Float 4 -> ZBUF",         "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4",          "test_files/reference/ref_BSurF4ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurF4ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates tst_BSurF4ZB
   { "Array Float 4 -> COLORMAP",     "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4",          "test_files/reference/ref_BSurF4",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurF4.red (.grn, .blu), creates tst_BSurF4.red, grn and blu
   { "Array Float 4 -> GRAYIFF",      "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4Gray.iff",  "test_files/reference/ref_BSurF4Gray.iff",__LINE__ },  // OK -> display ref_BSurF4Gray.iff, identify ref_BSurF4Gray.iff
   { "Array Float 4 -> COLORIFF",     "test_files/source/BSur.DEMF4",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF4Color.iff", "test_files/reference/ref_BSurF4Color.iff",__LINE__},  // OK -> display ref_BSurF4Color.iff, identify ref_BSurF4Color.iff

   // BIN Array F8
   { "Array Float 8 -> Array Int 1",  "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, "-128","127",   0, 127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8S1",        "test_files/reference/ref_BSurF8S1",__LINE__       }, // OK -> display -depth   8 -size 258x258                               gray:ref_BSurF8S1
   { "Array Float 8 -> Array Int 2",  "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8S2",        "test_files/reference/ref_BSurF8S2",__LINE__       }, // OK ->  display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurF8S2
   { "Array Float 8 -> Array Int 4",  "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8S4",        "test_files/reference/ref_BSurF8S4",__LINE__       }, // OK -> display -depth  32 -size 258x258                               gray:ref_BSurF8S4
   { "Array Float 8 -> Array UInt 1", "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, "0","255",   0, 255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8U1",        "test_files/reference/ref_BSurF8U1",__LINE__       }, // OK -> display -depth   8 -size 258x258                               gray:ref_BSurF8U1
   { "Array Float 8 -> Array UInt 2", "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8U2",        "test_files/reference/ref_BSurF8U2",__LINE__       }, // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurF8U2
   { "Array Float 8 -> Array UInt 4", "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8U4",        "test_files/reference/ref_BSurF8U4",__LINE__       }, // OK -> display -depth  32 -size 258x258                               gray:ref_BSurF8U4
   { "Array Float 8 -> Array Float 4","test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8F4",        "test_files/reference/ref_BSurF8F4",__LINE__       }, // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurF8F4
   { "Array Float 8 -> Array Float 8","test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8F8",        "test_files/reference/ref_BSurF8F8",__LINE__       }, // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=7e+01 gray:ref_BSurF8F8
   { "Array Float 8 -> WCSDEM",       "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8",          "test_files/reference/ref_BSurF8",__LINE__         },
   { "Array Float 8 -> ZBUF",         "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8",          "test_files/reference/ref_BSurF8ZB",__LINE__       },  // OK -> tail --bytes $((258*258*4)) ref_BSurF8ZB | display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates tst_BSurF8ZB
   { "Array Float 8 -> COLORMAP",     "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8",          "test_files/reference/ref_BSurF8",__LINE__         },  // OK -> display -depth 8 -size 258x258 gray:ref_BSurF8.red (.grn, .blu), creates tst_BSurF8.red, grn and blu
   { "Array Float 8 -> GRAYIFF",      "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF, CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8Gray.iff",  "test_files/reference/ref_BSurF8Gray.iff",__LINE__ },  // OK -> display ref_BSurF8Gray.iff, identify ref_BSurF8Gray.iff
   { "Array Float 8 -> COLORIFF",     "test_files/source/BSur.DEMF8",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurF8Color.iff", "test_files/reference/ref_BSurF8Color.iff",__LINE__},  // OK -> display ref_BSurF8Color.iff, identify ref_BSurF8Color.iff
   ...
   { "ASCII Array -> Array Int 1",  "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASS1",        "test_files/reference/ref_BSurASS1",__LINE__       }, // OK -> display -depth  8 -size 258x258 gray:ref_BSurASS1
   { "ASCII Array -> Array Int 2",  "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASS2",        "test_files/reference/ref_BSurASS2",__LINE__       }, // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurASS2
   { "ASCII Array -> Array Int 4",  "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASS4",        "test_files/reference/ref_BSurASS4",__LINE__       }, // OK -> display -depth  32 -size 258x258 gray:ref_BSurASS3
   { "ASCII Array -> Array UInt 1", "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASU1",        "test_files/reference/ref_BSurASU1",__LINE__       }, // OK -> display -depth  8 -size 258x258 gray:ref_BSurASU1
   { "ASCII Array -> Array UInt 2", "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASU2",        "test_files/reference/ref_BSurASU2",__LINE__       }, // OK -> display -depth  16 -size 258x258 -define endian=MSB -normalize gray:ref_BSurASU2
   { "ASCII Array -> Array UInt 4", "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASU4",        "test_files/reference/ref_BSurASU4",__LINE__       }, // OK -> display -depth  32 -size 258x258 gray:ref_BSurASU4
   { "ASCII Array -> Array Float 4","test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASF4",        "test_files/reference/ref_BSurASF4",__LINE__       }, // OK -> display -endian MSB -depth 32 -size 258x258 -define quantum:format=floating-point -define quantum:scale=8e+01 gray:ref_BSurASF4
   { "ASCII Array -> Array Float 8","test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurASF8",        "test_files/reference/ref_BSurASF8",__LINE__       }, // OK -> display -endian MSB -depth 64 -size 258x258 -define quantum:format=floating-point -define quantum:scale=8e+01 gray:ref_BSurASF8
   { "ASCII Array -> WCSDEM",       "test_files/source/BSur.DEMAS",      DEM_DATA_INPUT_ASCII,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,   0, 258, 258, NULL,NULL,   0, 1122,   DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurAS",          "test_files/reference/ref_BSurAS",__LINE__         }, // OK -> loaded into WCS (new Project created, Convert DEM HI Lat/Lon 10, Lo Lat/Lon 0, Map View, Exag 192, Scale 273, Topo), creates tst_BSurGr.Obj and tst_BSurGr.elev
...
//   { "DTED 601x1201 -> Array Int 1",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTS1",        "test_files/reference/ref_BSurDTS1",__LINE__       },
//   { "DTED 601x1201 -> Array Int 2",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTS2",        "test_files/reference/ref_BSurDTS2",__LINE__       },
//   { "DTED 601x1201 -> Array Int 4",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTS4",        "test_files/reference/ref_BSurDTS4",__LINE__       },
//   { "DTED 601x1201 -> Array UInt 1",  "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTU1",        "test_files/reference/ref_BSurDTU1",__LINE__       },
//   { "DTED 601x1201 -> Array UInt 2",  "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTU2",        "test_files/reference/ref_BSurDTU2",__LINE__       },
//   { "DTED 601x1201 -> Array UInt 4",  "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_LONG,     258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTU4",        "test_files/reference/ref_BSurDTU4",__LINE__       },
//   { "DTED 601x1201 -> Array Float 4", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,     258, 258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurDTF4",        "test_files/reference/ref_BSurDTF4",__LINE__       },
//   { "DTED 601x1201 -> Array Float 8", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 1201, 601, NULL,NULL,  -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,  DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   601,1201,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_Rug601x1201DTF8", "test_files/reference/ref_Rug601x1201DTF8",__LINE__       },  // FALSCH !!! display -endian MSB -depth 64 -size 601x1201 -define quantum:format=floating-point -define quantum:scale=8e+03 gray:

   // square DTED works (Tenerife)
   { "DTED 1201x1201 -> Array 301x301 Int 2 Floor 0 SplConst","test_files/source/n28_w017_3arc_v2.dt1",     DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,1201,"0" ,NULL,   0, 3629, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   CmpBinaryExactly,0,DEM_DATA_FORMAT_SIGNEDINT,DEM_DATA_VALSIZE_SHORT,        301,  301,          1,          29.000000,    28.000000,     17.000000,    16.000000,        "tmp/WCS_Test/", "tst_ten_301x301FlSCS2","test_files/reference/ref_Ten301x301_FlSpl.binS2",__LINE__},           //display -depth 16 -size 301x301 -define endian=MSB -normalize gray:ref_Ten301x301_FlSpl.binS2
   ...
   //                                          SourceFileName,                                 InFormat,              InValueFormat,              InValueSize,         HeaderBytes, Rows,Cols, MinEl,MaxEl,                              OutFormat,          OutValueFormat,                                       OutValueSize,           OutRows, OutCols, Spline Constraint,  Hi_Lat,        Lo_Lat,       Hi_Long,      Lo_Long,            outDir,        outNameBase,               refFileName
     { "DTED 601x1201 -> WCSDEM 601x1201", "test_files/source/n54_e013_3arc_v2.dt1",     DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,601, NULL,NULL, -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,     1201,  601,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "tmp/WCS_Test/", "tst_RuegDT",          "test_files/reference/ref_RuegenDT",__LINE__         },

// Scaling
	 { "DTED 601x1201 -> WCSDEM 301x601", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,601, NULL,NULL, -12,  170, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,      601,  301,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "tmp/WCS_Test/", "tst_RuegSc",          "test_files/reference/ref_RuegenDTScale",__LINE__    },
     // other Scaling (Scaling x!=y) + Spline Constraint
	 { "DTED 601x1201 -> WCSDEM 301x301 Spline Constraint", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,601, NULL,NULL, -12,  170, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,      301,  301,          1,          55.000000,    54.000000,    -13.000000,   -14.000000,        "tmp/WCS_Test/", "tst_RuegSS",          "test_files/reference/ref_RuegenDTScaleSplineConstr",__LINE__         },

//	{ "DTED 601x1201 -> ZBUF",         "test_files/source/BSurDEMColr.iff", DEM_DATA_INPUT_IFF,      DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_Rug601x1201DT",        "test_files/reference/ref_Rug601x1201DTZB",__LINE__       }, //  tail --bytes $((601*1201*4)) ref_Rug601x1201DTZB | display -endian MSB -depth 32 -size 601x1201 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates ref_Rug601x1201DTZB
//	{ "DTED 601x1201 -> COLORMAP",     "test_files/source/BSurDEMColr.iff", DEM_DATA_INPUT_IFF,      DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_Rug601x1201DT",          "test_files/reference/ref_Rug601x1201DT",__LINE__       }, //  display -depth 8 -size 601x1201 gray:ref_Rug601x1201DT.red (.grn, .blu), creates tst_Rug601x1201DT.red, grn and blu,
//
//	// DTED -> Gray IFF no Scaling
//    { "DTED 601x1201 -> GRAYIFF no Scaling","test_files/source/n54_e013_3arc_v2.dt1",                    DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,601, NULL,NULL, -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_GRAYIFF,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,     1201,  601,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "tmp/WCS_Test/", "tst_RuegDTGray.iff",          "test_files/reference/ref_RuegenDTGray.iff",__LINE__         },  // FAILED
//	// DTED -> Color IFF no Scaling
//    { "DTED 601x1201 -> COLORIFF no Scaling","test_files/source/n54_e013_3arc_v2.dt1",                    DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        1201,601, NULL,NULL, -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORIFF,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,     1201,  601,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "tmp/WCS_Test/", "tst_RuegDTColor.iff",          "test_files/reference/ref_RuegenDTColor.iff",__LINE__         },  // FAILED
...
// 1 (Elev)   /* geht schief! */   { "test_files/source/36112.I   .elev", DEM_DATA_INPUT_WCSDEM,   DEM_DATA_FORMAT_UNKNOWN,   DEM_DATA_VALSIZE_UNKNOWN, 68, 301, 301,  651, 2316, DEM_DATA_OUTPUT_WCSDEM,  DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_36112I",          "test_files/reference/ref_36112I",__LINE__         },
//  /* geht schief! */   { "test_files/source/BSur.DEMZB",      DEM_DATA_INPUT_ZBUF,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_LONG,    64, 258, 258,    0, 1122, DEM_DATA_OUTPUT_WCSDEM,  DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "tmp/WCS_Test/", "tst_BSurZB",          "test_files/reference/ref_BSurZB",__LINE__         }
...
__stdargs int main(int argc, char **argv)   // I compile with -mregparm. Then __stdargs is needed to get real argc/argv
{
...

    {
    	 ...
    	 if (getcwd(cwd, sizeof(cwd)) != NULL) {
    	         ...
    	         perror("getcwd() Fehler");
    	     }
    }


    rmtree("tmp");  // remove directory and everything below

    Res=Mkdir("tmp");
    if(Res!=0)
    {
    	printf("Res=%d! MKdir tmp failed!\n",Res);
    	return 3;   // return error
    }

    Res=Mkdir("tmp/WCS_Test");
    if(Res!=0)
    {
    	printf("Res=%d! MKdir tmp/WCS_Test failed!\n",Res);
    	return 3;   // return error
    }
...
char *File1="tmp/tst_Alps_1.elev";
char *File2="tmp/tst_Alps_2.elev";
