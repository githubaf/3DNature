...
//   { "DTED 601x1201 -> Array Int 1",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     258, 258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurDTS1",        "test_files/reference/ref_BSurDTS1",__LINE__       },
//   { "DTED 601x1201 -> Array Int 2",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258, 258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurDTS2",        "test_files/reference/ref_BSurDTS2",__LINE__       },
//   { "DTED 601x1201 -> Array Int 4",   "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258, 258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurDTS4",        "test_files/reference/ref_BSurDTS4",__LINE__       },
//   { "DTED 601x1201 -> Array UInt 1",  "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_BYTE,     258, 258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurDTU1",        "test_files/reference/ref_BSurDTU1",__LINE__       },
//   { "DTED 601x1201 -> Array UInt 2",  "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0,  258, 258, NULL,NULL,    0, 1122, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,   DEM_DATA_FORMAT_UNSIGNEDINT, DEM_DATA_VALSIZE_SHORT,    258, 258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurDTU2",        "test_files/reference/ref_BSurDTU2",__LINE__       },
...
//   { "DTED 601x1201 -> Array Float 8", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 1201, 601, NULL,NULL,  -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY, CmpBinaryExactly, 0,  DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   601,1201,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_Rug601x1201DTF8", "test_files/reference/ref_Rug601x1201DTF8",__LINE__       },  // FALSCH !!! display -endian MSB -depth 64 -size 601x1201 -define quantum:format=floating-point -define quantum:scale=8e+03 gray:
   ...
   //                                          SourceFileName,                                 InFormat,              InValueFormat,              InValueSize,         HeaderBytes, Rows,Cols, MinEl,MaxEl,                              OutFormat,          OutValueFormat,                                       OutValueSize,           OutRows, OutCols, Spline Constraint,  Hi_Lat,        Lo_Lat,       Hi_Long,      Lo_Long,            outDir,        outNameBase,               refFileName
     { "DTED 601x1201 -> WCSDEM 601x1201", "test_files/source/n54_e013_3arc_v2.dt1",     DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        601,1201, NULL,NULL, -18,  173, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,     601,  1201,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "Ram:WCS_Test/", "tst_RuegDT",          "test_files/reference/ref_RuegenDT",__LINE__         },

// Scaling
	 { "DTED 601x1201 -> WCSDEM 301x601", "test_files/source/n54_e013_3arc_v2.dt1",      DEM_DATA_INPUT_DTED,     DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    0,        601,1201, NULL,NULL, -12,  170, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_WCSDEM,  CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,  DEM_DATA_VALSIZE_UNKNOWN,      301,  601,          0,          55.000000,    54.000000,    -13.000000,   -14.000000,        "Ram:WCS_Test/", "tst_RuegSc",          "test_files/reference/ref_RuegenDTScale",__LINE__    },
...
//	{ "DTED 601x1201 -> ZBUF",         "test_files/source/BSurDEMColr.iff", DEM_DATA_INPUT_IFF,      DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ZBUF,    CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_Rug601x1201DT",        "test_files/reference/ref_Rug601x1201DTZB",__LINE__       }, //  tail --bytes $((601*1201*4)) ref_Rug601x1201DTZB | display -endian MSB -depth 32 -size 601x1201 -define quantum:format=floating-point -define quantum:offset=100 -define quantum:scale=8e+01 gray: #creates ref_Rug601x1201DTZB
//	{ "DTED 601x1201 -> COLORMAP",     "test_files/source/BSurDEMColr.iff", DEM_DATA_INPUT_IFF,      DEM_DATA_FORMAT_FLOAT,       DEM_DATA_VALSIZE_DOUBLE,   0, 258, 258, NULL,NULL,   0,  255, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_COLORMAP,CmpBinaryExactly,0,DEM_DATA_FORMAT_UNKNOWN,     DEM_DATA_VALSIZE_UNKNOWN,  258,258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_Rug601x1201DT",          "test_files/reference/ref_Rug601x1201DT",__LINE__       }, //  display -depth 8 -size 601x1201 gray:ref_Rug601x1201DT.red (.grn, .blu), creates tst_Rug601x1201DT.red, grn and blu,
//
