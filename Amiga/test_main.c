...
#define oritzroiuzoritzoiu
   ...
   { "Array Int 1 -> Array Int 2",  "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258,    0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_SHORT,    258,258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurS1S2",        "test_files/reference/ref_BSurS1S2",__LINE__       },  // ??? -> display -depth  16 -size 258x258 gray:ref_BSurS1S2
   { "Array Int 1 -> Array Int 4",  "test_files/source/BSur.DEMS1",      DEM_DATA_INPUT_ARRAY,    DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_BYTE,     0, 258, 258,    0,  127, DEM_DATA_UNITS_METERS, DEM_DATA_OUTPUT_ARRAY,   DEM_DATA_FORMAT_SIGNEDINT,   DEM_DATA_VALSIZE_LONG,     258,258,0, 0,        0,          0,          0,        "Ram:WCS_Test/", "tst_BSurS1S4",        "test_files/reference/ref_BSurS1S4",__LINE__       },  // ??? -> display -depth  32 -size 258x258 gray:ref_BSurS1S4
