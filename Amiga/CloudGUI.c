 ...
 CL_Win->WKS.Precision = WCS_KFPRECISION_FLOAT;
	...
	Child, ColGroup(4),
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_String_Accept, "0123456789", End,
	    Child, CL_Win->CloudArrow[0][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[0][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  Child, Label2("Cols"),
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "0123456789", End,
	    Child, CL_Win->CloudArrow[1][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[1][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->CloudArrow[2][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[2][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  Child, Label2("Min"),
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->CloudArrow[3][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[3][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->CloudArrow[4][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[4][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  Child, Label2("Min"),
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->CloudArrow[5][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->CloudArrow[5][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  End, /* ColGroup */
	...
	Child, ColGroup(4),
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, ".0123456789", End,
	    Child, CL_Win->FloatArrow[0][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[0][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, ".0123456789", End,
	    Child, CL_Win->FloatArrow[1][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[1][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, ".0123456789", End,
	    Child, CL_Win->FloatArrow[2][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[2][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, ".0123456789", End,
	    Child, CL_Win->FloatArrow[3][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[3][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->FloatArrow[5][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[5][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  Child, Label2("Lon"),
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->FloatArrow[6][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[6][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  End, /* ColGroup */
	Child, HGroup,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "0123456",
		MUIA_String_Accept, "-.0123456789", End,
	    Child, CL_Win->FloatArrow[4][0] = ImageButton(MUII_ArrowLeft),
	    Child, CL_Win->FloatArrow[4][1] = ImageButton(MUII_ArrowRight),
	    End, /* HGroup */
	  End, /* HGroup */
	  ...
	  Child, TextObject, MUIA_Text_Contents, "\33c\0334Key Frames", End,
          Child, HGroup,
			...
			MUIA_FixWidthTxt, "012345", End,
              Child, CL_Win->GKS.StrArrow[0] = ImageButton(MUII_ArrowLeft),
              Child, CL_Win->GKS.StrArrow[1] = ImageButton(MUII_ArrowRight),
              End, /* HGroup */
