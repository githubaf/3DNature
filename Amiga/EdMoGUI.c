...
/* Set active gadget */
  set(EM_Win->MotionWin, MUIA_Window_ActiveObject, EM_Win->LS_List);
  ...
  switch (WCS_ID & 0x0000ff00)
   ...
   case GP_STRING1:
    ...
    if (i < 3)
     ...
     set(EM_Win->ValTxt[i], MUIA_String_Contents, str);
     ...
     set(EM_Win->ValTxt[0], MUIA_String_Contents, str);
     set(EM_Win->ValTxt[0], MUIA_String_BufferPos, 0);
     sprintf(str, "%f", PAR_FIRST_MOTION(item[1]));
     set(EM_Win->ValTxt[1], MUIA_String_Contents, str);
...
/* set values in interactive group texts */
 if (incr[0] == 0.0)
  {
  set(EM_Win->ParTxt[0], MUIA_Text_Contents, "\0");
  sprintf(str, "%f", PAR_FIRST_MOTION(item[1]));
  set(EM_Win->ValTxt[0], MUIA_String_Contents, "\0");
  set(EM_Win->ValTxt[0], MUIA_String_BufferPos, 0);
  ...
  {
  set(EM_Win->ParTxt[0], MUIA_Text_Contents, varname[item[0]]);
  sprintf(str, "%f", PAR_FIRST_MOTION(item[0]));
  set(EM_Win->ValTxt[0], MUIA_String_Contents, str);
  set(EM_Win->ValTxt[0], MUIA_String_BufferPos, 0);
 ...
 if (incr[1] == 0.0)
  {
  set(EM_Win->ParTxt[1], MUIA_Text_Contents, "\0");
  sprintf(str, "%f", PAR_FIRST_MOTION(item[1]));
  set(EM_Win->ValTxt[1], MUIA_String_Contents, "\0");
  set(EM_Win->ValTxt[1], MUIA_String_BufferPos, 0);
  ...
  {
  set(EM_Win->ParTxt[1], MUIA_Text_Contents, varname[item[1]]);
  sprintf(str, "%f", PAR_FIRST_MOTION(item[1]));
  set(EM_Win->ValTxt[1], MUIA_String_Contents, str);
  set(EM_Win->ValTxt[1], MUIA_String_BufferPos, 0);
 ...
 if (incr[2] == 0.0)
  {
  set(EM_Win->ParTxt[2], MUIA_Text_Contents, "\0");
  sprintf(str, "%f", PAR_FIRST_MOTION(item[2]));
  set(EM_Win->ValTxt[2], MUIA_String_Contents, "\0");
  ...
  {
  set(EM_Win->ParTxt[2], MUIA_Text_Contents, varname[item[2]]);
  sprintf(str, "%f", PAR_FIRST_MOTION(item[2]));
  set(EM_Win->ValTxt[2], MUIA_String_Contents, str);
  set(EM_Win->ValTxt[2], MUIA_String_BufferPos, 0);
...
/* update radial text */
 ...
 set(EM_Win->ValTxt[3], MUIA_String_Contents, str);
 set(EM_Win->ValTxt[3], MUIA_String_BufferPos, 0);
 sprintf(str, "%f", focdist);
 set(EM_Win->ValTxt[4], MUIA_String_Contents, str);
...
/* Set active gadget */
  set(EMPL_Win->ParListWin, MUIA_Window_ActiveObject, EMPL_Win->LS_List);
