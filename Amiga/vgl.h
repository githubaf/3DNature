/*
 *  VGL  -  The Vigra Graphics Library
 *
 *  (C) Copyright 1993, 1994, Vigra.  All rights reserved.
 *
 *   Vigra
 ...
 *   (619) 597-7094 (fax)
 *
 *   This source code is provided for the purpose of compilation and
 *   reference only.  Modification of the code within without the written
 *   consent of Vigra voids any warranty-- expressed or implied.
 *
 *   Vigra reserved the right to make improvements in the software or
