	...
	Child, HGroup,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "012345", End,
            Child, EMTL_Win->StrArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, EMTL_Win->StrArrow[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  Child, RectangleObject, End,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "01234", End,
            Child, EMTL_Win->TxtArrowLg[0] = ImageButton(MUII_ArrowLeft),
            Child, EMTL_Win->TxtArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, EMTL_Win->TxtArrow[1] = ImageButton(MUII_ArrowRight),
            Child, EMTL_Win->TxtArrowLg[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  End, /* HGroup */
	Child, HGroup,
  ...
  Set_Param_Menu(1);
	...
	Child, HGroup,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "012345", End,
            Child, ECTL_Win->StrArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, ECTL_Win->StrArrow[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  Child, RectangleObject, End,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "01234", End,
            Child, ECTL_Win->TxtArrowLg[0] = ImageButton(MUII_ArrowLeft),
            Child, ECTL_Win->TxtArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, ECTL_Win->TxtArrow[1] = ImageButton(MUII_ArrowRight),
            Child, ECTL_Win->TxtArrowLg[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  End, /* HGroup */
	Child, HGroup,
  ...
  Set_Param_Menu(2);
	...
	Child, HGroup,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "012345", End,
            Child, EETL_Win->StrArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, EETL_Win->StrArrow[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  Child, RectangleObject, End,
	  ...
	  Child, HGroup, MUIA_Group_HorizSpacing, 0,
		...
		MUIA_FixWidthTxt, "01234", End,
            Child, EETL_Win->TxtArrowLg[0] = ImageButton(MUII_ArrowLeft),
            Child, EETL_Win->TxtArrow[0] = ImageButton(MUII_ArrowLeft),
            Child, EETL_Win->TxtArrow[1] = ImageButton(MUII_ArrowRight),
            Child, EETL_Win->TxtArrowLg[1] = ImageButton(MUII_ArrowRight),
            End, /* HGroup */
	  End, /* HGroup */
	Child, HGroup,
