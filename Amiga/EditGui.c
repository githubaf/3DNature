...
/* Palette modifying prop gadgets, etc. */
			...
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[0][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[0][1] = ImageButton(MUII_ArrowRight),
			...
			MUIA_String_Accept, "0123456789",
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[1][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[1][1] = ImageButton(MUII_ArrowRight),
			...
			MUIA_String_Accept, "0123456789",
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[2][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[2][1] = ImageButton(MUII_ArrowRight),
...
*/
		...
		End, /* HGroup */
			...
			MUIA_String_Accept, "0123456789",
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[3][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[3][1] = ImageButton(MUII_ArrowRight),
			...
			MUIA_String_Accept, "0123456789",
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[4][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[4][1] = ImageButton(MUII_ArrowRight),
			...
			MUIA_String_Accept, "0123456789",
			MUIA_FixWidthTxt, "0123", End,
                Child, EC_Win->PropArrow[5][0] = ImageButton(MUII_ArrowLeft),
                Child, EC_Win->PropArrow[5][1] = ImageButton(MUII_ArrowRight),
...
/* Frame stuff */
	      ...
	      Child, TextObject, MUIA_Text_Contents, "\33c\0334Key Frames", End,
			...
			MUIA_FixWidthTxt, "012345", End,
                  Child, EC_Win->StrArrow[0][0] = ImageButton(MUII_ArrowLeft),
                  Child, EC_Win->StrArrow[0][1] = ImageButton(MUII_ArrowRight),
                  End, /* HGroup */
...
/* Set active gadget */
  set(EC_Win->EcoPalWin, MUIA_Window_ActiveObject, EC_Win->LS_List);
...
void SetColorRequester(short row)
{
 struct PaletteItem Pal;
  ...
  set(EC_Win->Nme[row], MUIA_Text_Contents, EC_Win->Colorname[EC_Win->PaI[row]]);
...
void Set_EC_Item(short item)
{
 ...
 set(EC_Win->Str[5], MUIA_String_Contents, PAR_NAME_COLOR(item));
