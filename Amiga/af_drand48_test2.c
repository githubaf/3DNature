...
sc af_drand48_test2.c DEFINE=DRIVER LINK MATH=STANDARD TO af_drand48_test2_sasc
...
{
   x=erand48(seed);
   printf("%f,  seed=%04x %04x %04x\n",x,seed[2],seed[1],seed[0]);
}
...
seed[2]=0xa7c0;
seed[1]=0x67b7;
seed[0]=0x5101; //0xb8b8;

seed[0]=(short)seed[0]+(short)seed[1];  printf("Seed korrigiert: %04hx\n",seed[0]);
x=erand48(seed);
printf("%f\n",x);
