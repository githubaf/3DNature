...
*/
 ...
 data->textwidthtop 	= TextLength(_rp(obj), (STRPTR)str, strlen(str));
 sprintf(str, "%3.2f", data->textlowval);
 data->textwidthbottom = TextLength(_rp(obj), (STRPTR)str, strlen(str));
 data->textwidthzero = TextLength(_rp(obj), (STRPTR)"0.00", 4);
...
/*   RectFill(_rp(obj), data->left, data->top, data->right, data->bottom); */
   ...
   Text(_rp(obj), (STRPTR)str, strlen(str));
   ...
   Move(_rp(obj), data->right - TextLength(_rp(obj), (STRPTR)str, strlen(str)), data->textbottom);
   Text(_rp(obj), (STRPTR)str, strlen(str));
/*   } */ /* if clear display */
