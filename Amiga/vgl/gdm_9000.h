...
/*  Certain things about REV A operate differently than newer revs.
 *  Defining this makes VGL work with REV A __ONLY__.
 */
#define GDM_9000_REV_A
...
typedef struct
  {
    DUART_68681_CHANNEL  chan1;
    ulong                ipcr_acr;
    ulong                isr_imr;
    ulong                cur_ctur;
    ulong                clr_ctlr;
    DUART_68681_CHANNEL  chan2;
    ulong                ivr;
    ulong                ip_opcr;
    ulong                start_oset;
    ulong                stop_oreset;
...
typedef struct
  {
    ...
    ulong	intr_dis;
    ulong	reset;
    char	__fill00[0x03FFF0];
    DUART_68681 duart;
    char	__fill01[0x03FFC0];
    KBD_8042    kbd;
    char	__fill02[0x03FFF8];
    ulong       ivr;
    char	__fill03[0x03FFFC];
...
#define P9000_busy_wait(vgboard)  {while ((((board_gdm_9000 *)((vgboard)->addr))->p9000_bt445.status & P9000_BUSY)!=0);}

#define P9000_issue_wait(vgboard)  {while ((((board_gdm_9000 *)((vgboard)->addr))->p9000_bt445.status & P9000_ISSUE)!=0);}
